...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        # url avec /graph dedans = génère l'image png avec mathplot
        if self.path.find("graph1")>0:
            ...
            self.end_headers()
            self.wfile.write(bytes("<html><head><title>Simulation</title><link rel=stylesheet href=https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css></head>", "utf-8"))
            self.wfile.write(bytes("<form action=go><body style='margin:10px'><div class=form-group>", "utf-8"))
            ...
            self.wfile.write(bytes("</div></body></form></html>", "utf-8"))
